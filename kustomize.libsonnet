...
//  https://github.com/nholuongut/kustomize/blob/master/docs/kustomization.yaml
//
...

{
  ...
  commonLabels(l):: function(o) (
    ...
    // Kustomize's list is in https://github.com/nholuongut/kustomize/blob/master/pkg/transformers/config/defaultconfig/commonlabels.go
